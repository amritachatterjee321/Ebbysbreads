            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-4">
                  <a href="https://wa.me/919560487800" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700">
                  ...
                  <a href="mailto:ebbysbreads@gmail.com" className="text-red-600 hover:text-red-700">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <a href="#menu" className="block text-gray-600 hover:text-orange-600 transition-colors">Our Menu</a>
                  <a href="#about" className="block text-gray-600 hover:text-orange-600 transition-colors">About Us</a>
                  <a href="#delivery" className="block text-gray-600 hover:text-orange-600 transition-colors">Delivery Info</a>
                  <a href="#orders" className="block text-gray-600 hover:text-orange-600 transition-colors">Track Order</a>
                </div>
              </div>
